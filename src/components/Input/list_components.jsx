...
export function ListComponents(){
    ...
    return (
        <div>
            {isOpen ? (
            <div className="flex">
                <button className="flex p-1" onClick={handleClose}> 
                    <BsList className="text-red-500 text-3xl  bg-white border border-black rounded-md"/>
                </button>
            ...
            <button className="flex p-1" onClick={handleOpen}> 
