function PlayControls({ volChange, onVolChange }) {
    return (
        <>
            ...
            <div className="input-group mb-3">
                ...
                <input type="text" className="form-control" id="speedInput" placeholder="120" aria-label="speed" aria-describedby="speed_label" />
            </div>

            {/* Volume */}
            <label htmlFor="volumeRange" className="form-label">Volume</label>
            <input type="range" className="form-range" min="0" max="1" step="0.01" onChange={onVolChange} id="customRange3" />
