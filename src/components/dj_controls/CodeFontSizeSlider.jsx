...
function CodeFontSizeSlider({ codeFontSize, setCodeFontSize, onHandleGeneric, onHandleFontSize }) {
    return (
        <div className="input-group mb-4">
            ...
            <input type="range" className="col-lg menu_label_value slider" min="6" max="40" value={codeFontSize} step="1" defaultValue="18" id="font_size_range" onDragEnd={onHandleFontSize} onChange={(e) => {
